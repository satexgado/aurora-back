...
class MpMarcheEtapeController extends LaravelController
{
    ...
    public function attachAffectation(Request $request)
    {
        ...
        $item = MpMarcheEtape::find($item_id);
    ...
    public function getAffectation(MpMarcheEtape $MpMarcheEtape)
    {
