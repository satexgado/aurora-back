...
class MpTypeProcedureController extends LaravelController
{
    ...
    public function filterNoChild(myBuilder $query, $method, $clauseOperator, $value, $in)
    {
        if ($value) {
            $query->doesntHave('mp_type_procedures');
        }
    }
    ...
    {
        if ($value) {
            $query->doesntHave('mp_type_procedure');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $item = MpTypeProcedure::findOrFail($id);
    ...
    public function attachAffectation(Request $request)
    {
        ...
        $item = MpTypeProcedure::find($item_id);
    ...
    public function getAffectation(MpTypeProcedure $MpTypeProcedure)
    {
