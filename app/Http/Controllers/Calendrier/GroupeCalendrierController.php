...
use App\Models\Calendrier\CalGroupeCalendrier;
use Illuminate\Support\Facades\DB;
use Auth;

class GroupeCalendrierController extends LaravelController
{
    ...
    public function getAll(Request $request)
    {
        ...
        $query = CalGroupeCalendrier::query();
    ...
    {
        $q = "%" .$request->search . "%";
        $item = CalGroupeCalendrier::where('libelle', 'like',$q)->get(['id_type_postes as value','libelle as libelle']);
        return response()
        ->json($item);
    }
    ...
    {
        $q = "%" .$request->search . "%";
        $item = CalGroupeCalendrier::where('libelle', 'like',$q)->get(['id_type_postes as id','libelle as text']);
        return response()
        ->json(['items' => $item]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $item = CalGroupeCalendrier::create([
            'inscription' => Auth::id(),
    ...
    public function update(Request $request, $id)
    {
        ...
        $item = CalGroupeCalendrier::findOrFail($id);
    ...
    public function setAffectation(Request $request)
    {
        ...
        try {
            ...
            $item = CalGroupeCalendrier::find($Batiment_id);
    ...
    public function getAffectation(CalGroupeCalendrier $batiment)
    {
    ...
    public function attachAffectation(Request $request)
    {
        ...
        $item = CalGroupeCalendrier::find($item_id);
