...
class CrAmpiliationController extends LaravelController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $item = CrAmpiliation::findOrFail($id);
    ...
    public function attachAffectation(Request $request)
    {
        ...
        $item = CrAmpiliation::find($item_id);
    ...
    public function getAffectation(CrAmpiliation $CrAmpiliation)
    {
