...
class CrTypeController extends LaravelController
{
    ...
    {
        $restoreDataId = CrType::withTrashed()->findOrFail($id);
    ...
    public function getAffectation(CrType $CrType)
    {
