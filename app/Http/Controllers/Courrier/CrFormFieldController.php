...
class CrFormFieldController extends LaravelController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $item = CrFormField::findOrFail($id);
    ...
    {
        $restoreDataId = CrFormField::withTrashed()->findOrFail($id);
    ...
    public function getAffectation(CrFormField $CrFormField)
    {
