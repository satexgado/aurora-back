...
use App\Models\Courrier\CrMoyenSuivi;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\DB;

class CrMoyenSuiviController extends LaravelController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $item = CrMoyenSuivi::findOrFail($id);
    ...
    {
        $restoreDataId = CrMoyenSuivi::withTrashed()->findOrFail($id);
    ...
    public function attachAffectation(Request $request)
    {
        ...
        $item = CrMoyenSuivi::find($item_id);
    ...
    public function getAffectation(CrMoyenSuivi $CrMoyenSuivi)
    {
