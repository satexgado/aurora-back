...
class CrUrgenceController extends LaravelController
{
    ...
    {
        $restoreDataId = CrUrgence::withTrashed()->findOrFail($id);
    ...
    public function getAffectation(CrUrgence $CrUrgence)
    {
