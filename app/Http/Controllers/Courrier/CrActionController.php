...
use App\Models\Courrier\CrAction;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\DB;

class CrActionController extends LaravelController
{
    ...
    {
        $restoreDataId = CrAction::withTrashed()->findOrFail($id);
    ...
    public function getAffectation(CrAction $CrAction)
    {
