...
use App\Models\Courrier\CrMailTag;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\DB;

class CrMailTagController extends LaravelController
{
    ...
    public function getAffectation(CrMailTag $CrMailTag)
    {
