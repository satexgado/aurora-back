...
use App\Models\Ged\GedWorkspaceGroupe;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\DB;

class GedWorkspaceGroupeController extends LaravelController
{
    ...
    public function getAll(Request $request)
    {
        ...
        $query = GedWorkspaceGroupe::query();
    ...
    public function store(Request $request)
    {
        ...
        $item = GedWorkspaceGroupe::create([
    ...
    public function update(Request $request, $id)
    {
        ...
        $item = GedWorkspaceGroupe::findOrFail($id);
    ...
    {
        $restoreDataId = GedWorkspaceGroupe::withTrashed()->findOrFail($id);
    ...
    public function attachAffectation(Request $request)
    {
        ...
        $item = GedWorkspaceGroupe::find($item_id);
    ...
    public function getAffectation(GedWorkspaceGroupe $GedWorkspaceGroupe)
    {
