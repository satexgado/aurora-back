...
class FichierTypeController extends LaravelController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $item = FichierType::findOrFail($id);
    ...
    {
        $restoreDataId = FichierType::withTrashed()->findOrFail($id);
    ...
    public function getAffectation(FichierType $FichierType)
    {
