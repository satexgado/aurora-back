...
class MpMarche extends Eloquent
{
	...
	{
		return $this->belongsTo(\App\Models\Structure::class, 'service_contractant_id')->withTrashed();
	}

    public function fournisseur()
	{
		return $this->belongsTo(\App\Models\Courrier\CrCoordonnee::class, 'fournisseur_id')->withTrashed();
	}

	public function mp_type_marche()
	{
		return $this->belongsTo(\App\Models\MarchePublic\MpTypeMarche::class, 'type_marche_id')->withTrashed();
	}

	public function mp_type_procedure()
	{
		return $this->belongsTo(\App\Models\MarchePublic\MpTypeProcedure::class, 'type_procedure_id')->withTrashed();
	}
    ...
    {
        return $this->belongsToMany(\App\Models\Courrier\CrCoordonnee::class, 'mp_affectation_marche_fournisseur', 'marche', 'coordonnee')->withTrashed();
    }

    public function partenaires()
    {
        return $this->belongsToMany(\App\Models\Courrier\CrCoordonnee::class, 'mp_affectation_marche_partenaire', 'marche', 'coordonnee')->withTrashed();
    }
}
