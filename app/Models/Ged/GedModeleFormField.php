 ...
 * @package App\Models
 */
class GedModeleFormField extends Eloquent
{
	use \Illuminate\Database\Eloquent\SoftDeletes;
	protected $table = 'ged_modele_form_field';
    ...
    public function ged_modele()
	{
		return $this->belongsTo(\App\Models\Ged\GedModele::class, 'modele_id');
	}
