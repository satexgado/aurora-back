 ...
 * @package App\Models
 */
class CrCourrierWLink extends Eloquent
{
    ...
    {
        $link ="";
        if($this->cr_courrier_entrants()->count()) {
            $link = '/courrier/entrant/'.$this->cr_courrier_entrants()->first()->id;
        } else if($this->cr_courrier_sortants()->count()) {
            $link = '/courrier/sortant/'.$this->cr_courrier_sortants()->first()->id;
        }
        return $link;
    }
