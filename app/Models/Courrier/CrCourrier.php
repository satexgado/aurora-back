...
class CrCourrier extends Eloquent
{
    ...
    {
        return $this->belongsTo(\App\Models\Inscription::class, 'inscription_id')->withTrashed();
    }

    public function suivi_par_inscription()
    {
        return $this->belongsTo(\App\Models\Inscription::class, 'suivi_par')->withTrashed();
    }
    ...
    {
        return $this->belongsTo(\App\Models\Structure::class)->withTrashed();
    }
    ...
    {
        return $this->belongsTo(\App\Models\Courrier\CrType::class, 'type_id')->withTrashed();
    }

    public function cr_nature()
    {
        return $this->belongsTo(\App\Models\Courrier\CrNature::class, 'nature_id')->withTrashed();
    }

    public function cr_urgence()
    {
        return $this->belongsTo(\App\Models\Courrier\CrUrgence::class, 'urgence_id')->withTrashed();
    }
    ...
    {
        return $this->belongsTo(\App\Models\Courrier\CrStatut::class, 'statut_id')->withTrashed();
    }
	...
	{
		return $this->belongsToMany(\App\Models\Ged\Dossier::class, 'cr_courrier_dossier', 'courrier_id', 'dossier_id')->withTrashed();
	}

    public function dossier()
	{
		return $this->hasOneThrough(\App\Models\Ged\Dossier::class, 'cr_courrier_dossier', 'courrier_id', 'dossier.id', 'cr_courrier.id', 'dossier_id')->withTrashed();
    }
