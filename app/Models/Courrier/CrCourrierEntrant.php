...
class CrCourrierEntrant extends Eloquent
{
	...
	{
		return $this->belongsTo(\App\Models\Courrier\CrProvenance::class, 'provenance')->withTrashed();
	}

	public function cr_courrier()
	{
		return $this->belongsTo(\App\Models\Courrier\CrCourrier::class, 'courrier_id')->withTrashed();
	}

	public function cr_coordonnee()
	{
		return $this->belongsTo(\App\Models\Courrier\CrCoordonnee::class, 'expediteur_id')->withTrashed();
	}

	public function inscription()
	{
		return $this->belongsTo(\App\Models\Inscription::class, 'responsable_id')->withTrashed();
	}
	...
	{
		return $this->hasMany(\App\Models\Courrier\CrCourrierSortant::class, 'courrier_entrant_id')->withTrashed();
	}
