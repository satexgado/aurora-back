...
class CrCourrierSortant extends Eloquent
{
	...
	{
		return $this->belongsTo(\App\Models\Courrier\CrCourrierEntrant::class, 'courrier_entrant_id')->withTrashed();
	}
	...
	{
		return $this->belongsTo(\App\Models\Inscription::class)->withTrashed();
	}
