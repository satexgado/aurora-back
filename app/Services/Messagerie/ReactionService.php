...
class ReactionService extends BaseService
{
    ...
    public function getFichierByDiscussion(ReactionApiRequest $request, $discussion) {
       return DB::table('reactions')->select(DB::raw("CONCAT('https://www.sigecam.org/express-courrier-backend/public/storage/', fichier) as fichier_url, fichier,discussion"))->whereNotNull('fichier')->where('discussion', $discussion)->get();
    }
